 ...
 *
 */
package net.mcreator.testingmobs;
...
@Mod("testing_mobs")
public class TestingMobsMod {
	public static final Logger LOGGER = LogManager.getLogger(TestingMobsMod.class);
	public static final String MODID = "testing_mobs";

	public TestingMobsMod() {
